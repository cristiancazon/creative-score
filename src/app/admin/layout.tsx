        ...
        <div className={`${lexend.className} flex min-h-screen bg-slate-50 dark:bg-[#060e20] text-slate-800 dark:text-slate-100 transition-colors duration-300`}>
            ...
            >
                ...
                <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
                    ...
                    {!sidebarOpen && <div className="h-6 mt-6 mb-2" />}
                    <a href="/downloads/CreativeScoreMX_v1.2.2.lplug4" download className={`flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-gray-800 text-green-400 hover:text-green-300 transition-colors ${!sidebarOpen ? 'justify-center' : ''}`} title="Download Logi Plugin v1.2.2">
                        <Download size={20} />
                        {sidebarOpen && <span className="whitespace-nowrap font-semibold">Get MX Plugin v1.2.2</span>}
                    </a>
                </nav>
